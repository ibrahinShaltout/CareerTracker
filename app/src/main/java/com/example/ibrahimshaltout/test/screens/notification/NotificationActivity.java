...
import com.example.ibrahimshaltout.test.screens.messages.Requests;
...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        request_list =findViewById(R.id.requestList);
...
//                                                                                                                                    sView.setBackgroundColor(ContextCompat.getColor(NotificationActivity.this, R.color.colorPrimary));
...
//                                                                                                    snackbar.show();
                                                        ...
                                                        if (which == 2) {
                                                            Intent profileIntent = new Intent(NotificationActivity.this, UserProfileActivity.class);
